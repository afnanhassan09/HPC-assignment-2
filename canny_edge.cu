...
int main(int argc, char *argv[])
{
    ...
    clock_t start, end;       /* Variables to store execution time */
    ...
    if (argc < 5)
    {
        ...
        fprintf(stderr, "      thigh:      Fraction (0.0-1.0) of the distribution of non-zero edge\n");
        fprintf(stderr, "                  strengths for hysteresis. The fraction is used to compute\n");
    ...
    cpu_time_used = ((double)(end - start)) / CLOCKS_PER_SEC; /* Compute execution time */
